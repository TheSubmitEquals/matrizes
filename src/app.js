...
$.getJSON('./src/squareMatrix.json', function(jd) {
    console.log(squareMatrix(new Matrix(jd.matrixOne.length, jd.matrixOne[0].length, jd.matrixOne), new Matrix(jd.matrixTwo.length, jd.matrixTwo[0].length, jd.matrixTwo)));
})